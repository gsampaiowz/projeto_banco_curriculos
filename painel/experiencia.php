...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-dark">Cadastro de Experiência</h1>                        
                    </div>
                    ...
                    <div class="col-xl-10 col-lg-8 align-items-center">
                        <form action="cadastra_experiencia.php" method="POST">
                            ...
                            <div class="form-group col-md-6">
                                    ...
                                    <input name="empresa" type="text" class="form-control" id="empresa" placeholder="digite o nome da Empresa">
                            </div>
                            <div class="form-group col-md-6">
                                    <label for="inputEmail4">Digite a Ocupação</label>
                                    <input name="ocupacao" type="text" class="form-control" id="ocupacao" 
                            ...
                            <button type="submit" class="btn btn-dark">Cadastrar Experiência</button>
                        </form>
                    </div>
                    <!-- espaço em branco -->
