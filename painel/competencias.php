...
?>
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-dark small">Acesso para <b><?php echo $tipo_acesso; ?></b></span>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-dark small">Bem vindo <b><?php echo $_SESSION['nome_user']; ?></b></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-dark">Cadastro de Competências</h1>                        
                    </div>
                    ...
                    <div class="col-xl-10 col-lg-8 align-items-center">
                        <form action="cadastra_competencia.php" method="POST">
                            ...
                            <button type="submit" class="btn btn-dark">Cadastrar Competência</button>
                        </form>
                    </div>
                    <!-- espaço em branco -->
