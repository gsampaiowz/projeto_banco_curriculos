...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-dark">Cadastro de Habilidades</h1>                        
                    </div>
                    ...
                    <div class="col-xl-10 col-lg-8 align-items-center">
                        <form action="cadastra_habilidade.php" method="POST">
                            ...
                            <div class="form-group col-md-6">
                                    <label for="inputEmail4">Digite sua habilidade</label>
                                    <input name="habilidade" type="text" class="form-control" id="habilidade" placeholder="digite sua habilidade">
                                </div>
                            
                            
                            
                            <button type="submit" class="btn btn-dark">Cadastrar Habilidade</button>
                        </form>
                    </div>
                    <!-- espaço em branco -->
